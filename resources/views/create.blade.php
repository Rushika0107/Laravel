...
<div class="container">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-10 ">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input vlaue="{{old('name')}}" type="text" class=" @error('name') is-invalid @enderror form-control form-control-lg" placeholder="Name"
                    name="name">
                    @error('name')
        ...
        <div class="mb-3">
            ...
            <input  vlaue="{{old('price')}}"type="text" class="  @error('sku') is-invalid @enderror form-control form-control-lg" placeholder="Price"
            name="price">
            @error('price')
                    <p class="invalid-name">{{$message}}</p>
                    @enderror
    ...
    <div class="mb-3">
        ...
        <input  vlaue="{{old('sku')}}" type="text" class=" @error('sku') is-invalid @enderror form-control form-control-lg" placeholder="Sku"
        name="sku">
        @error('sku')
                    <p class="invalid-name">{{$message}}</p>
                    @enderror
